...
class Preprocessor:
    ...
    def encodeCategoricalValues(self, data):
        ...
        # We will need to decode the predicted values back to original
    ...
    def impute_missing_values(self, data):
        ...
        try:
            ...
            # ounding the value because KNN imputer returns value between 0 and 1, but we need either 0 or 1
